...
**What it does:**
1. Checks if you're on main/master and asks if you want to create a new branch
2. Analyzes current git status
3. Reviews both staged and unstaged changes
4. Examines recent commit messages to match your repository's style
5. Drafts an appropriate commit message using Conventional Commits
...
**Features:**
- **Branch safety check**: Asks before committing to main/master
- Automatically drafts commit messages using Conventional Commits format
- Uses prefixes: `feat:`, `fix:`, `refactor:`, `chore:`
- Avoids committing files with secrets (.env, credentials.json)
- Clean commits without any AI attribution or co-author tags
...
**What it does:**
1. Checks if you're on main/master and asks if you want to create a new branch
2. Creates a new branch if requested
3. Stages and commits changes with an appropriate message
...
- Clean PRs without any AI attribution or co-author tags
